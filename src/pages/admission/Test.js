    ...
    return (
        <>
           <div className="row">
                ...
                <div id="ember1269" className="AccountBalanceCard ember-view">
                    <div className="Box u-mb-5">
                        <div className="row">
                            <div className="columns">
                                <h2>Estimated costs for this billing period</h2>
                                <p className="u-mb-3">This is the current costs for your usage this billing period. A breakdown of your costs is available below</p>
                                <div className="balance-container u-mt-0">
                                    <h1>$10.95</h1>
                                    <div className="columns small-4">
                                        <a href="/pay-now?i=c3d9b3" id="ember1270" className="Button Button--blue Button--fullWidth ember-view">Make an Early Payment</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="u-mt-5 u-mb-5">
                    <div id="ember1283" className="invoice-summary ember-view">
                        <table>
                            <thead className="invoice-header">
                                <tr>
                                    <th colSpan={3} className="u-pa-5">
                                        <div className="row">
                                            ...
                                            <div className="columns small-4 u-textAlignRight">
                                                <p>
                                                    Download:
                                                    <a rel="noopener noreferrer" target="_blank" id="ember1288" className="ember-view" href="/v2/customers/c3d9b324010c01d70ef5b9138632b7e987f80bbb/invoices/a40c8ed2-e977-4909-8b53-0bb4ce637ba0/pdf?i=c3d9b3">PDF</a>
                                                    •
                                                    <a rel="noopener noreferrer" target="_blank" id="ember1289" className="ember-view" href="/v2/customers/c3d9b324010c01d70ef5b9138632b7e987f80bbb/invoices/a40c8ed2-e977-4909-8b53-0bb4ce637ba0/csv?i=c3d9b3">CSV</a>              
                                                </p>
                                                <p>
                                                    <a role="button" className="invoice--expand-toggle" data-ember-action data-ember-action-1290={1290}>
                                                    Expand All
                                                    </a>
                                                </p>
                                            </div>
                        ...
                        <table>
                            <tbody className="invoice-line-items">
                                <tr className="invoice-item d-1 has-subitems   ">
                                    <td role="button" className="invoice-item--description" data-ember-action data-ember-action-2205={2205}>
                                        <span className="invoice-item--toggle Icon--arrowFilterDown">
                                        </span>
                                        <span className="invoice-item--description-text">Droplets (2)</span>
                                        {/**/}
                                    </td>
                                    <td className="invoice-item--detail">
                                        <a href="/droplets" rel="noopener noreferrer">View Droplets</a>
                                    </td>
                                    <td role="button" className="invoice-item--amount" data-ember-action data-ember-action-2206={2206}>
                                        $10.95    
                                    </td>
                                </tr>
                                <tr className="invoice-item--subitems">
                                    <td colSpan={3}>
                                        <table>
                                            <tbody>
                                                <tr className="invoice-item d-2    ">
                                                    <td role="button" className="invoice-item--description" data-ember-action data-ember-action-2209={2209}>
                                                        {/**/}    <span className="invoice-item--description-text">ksoft1 (s-1vcpu-1gb)</span>
                                                        {/**/}
                                                    </td>
                                                    <td className="invoice-item--detail">
                                                        <div role="button" data-ember-action data-ember-action-2210={2210}>
                                                            368 hours
                                                        </div>
                                                    </td>
                                                    <td role="button" className="invoice-item--amount" data-ember-action data-ember-action-2211={2211}>
                                                        $2.74    
                                                    </td>
                                                </tr>
                                                {/**/}
                                                <tr className="invoice-item d-2    ">
                                                    <td role="button" className="invoice-item--description" data-ember-action data-ember-action-2214={2214}>
                                                        {/**/}    <span className="invoice-item--description-text">unifa-wms (s-2vcpu-2gb)</span>
                                                        {/**/}
                                                    </td>
                                                    <td className="invoice-item--detail">
                                                        <div role="button" data-ember-action data-ember-action-2215={2215}>
                                                            368 hours
                                                        </div>
                                                    </td>
                                                    <td role="button" className="invoice-item--amount" data-ember-action data-ember-action-2216={2216}>
                                                        $8.21    
                                                    </td>
                                                </tr>
                                                {/**/}
                        ...
                        <div className="invoice-footer--wrap">
                            <table className="invoice-footer">
                                <tfoot>
                                    <tr className="invoice-item d-1    borderless">
                                        <td role="button" className="invoice-item--description" data-ember-action data-ember-action-2219={2219}>
                                            {/**/}    <span className="invoice-item--description-text">Subtotal</span>
                                            {/**/}
                                        </td>
                                        <td className="invoice-item--detail">
                                            <div role="button" data-ember-action data-ember-action-2220={2220}>
                                                &nbsp;
                                            </div>
                                        </td>
                                        <td role="button" className="invoice-item--amount" data-ember-action data-ember-action-2221={2221}>
                                            $10.95    
                                        </td>
                                    </tr>
                                    {/**/}
                                    <tr className="invoice-item d-1    ">
                                        <td role="button" className="invoice-item--description" data-ember-action data-ember-action-1317={1317}>
                                            {/**/}    <span className="invoice-item--description-text">Total</span>
                                            {/**/}
                                        </td>
                                        <td className="invoice-item--detail">
                                            <div role="button" data-ember-action data-ember-action-1318={1318}>
                                                &nbsp;
                                            </div>
                                        </td>
                                        <td role="button" className="invoice-item--amount" data-ember-action data-ember-action-1319={1319}>
                                            $10.95    
                                        </td>
                                    </tr>
                                    {/**/}    
                        ...
                        <div className="row u-mr-0">
                            <div className="column small-12 no-border u-mt-2 u-textAlignRight">
                                <small>
                                    *last updated 
                                    <div data-html="false" title data-toggle="tooltip" id="ember1327" data-original-title="Wed, Jun 16, 2021 at 7:45am GMT" className="tooltip-wrap ember-view">    <time dateTime="2021-06-16T07:45:11Z">7 hours ago</time>
                                    </div>
                                </small>
                            </div>
                        </div>
