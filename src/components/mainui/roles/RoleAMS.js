...
const RoleAMS = ({data}) => {
      ...
      const modules = [
		  ...
		  { title : 'Admission Letters', desc: 'Letters Module', url: '/app/ams?mod=letters&view=list',icon:'fa-file-alt', accessRoles: [] },
		  { title : 'Admitted Freshers', desc: 'Freshers Module', url: '/app/ams?mod=freshers&view=list',icon:'fa-user-check', accessRoles: [] },
		  { title : 'Entrance Exams', desc: 'Exams Module', url: '/app/ams?mod=entrance&view=list',icon:'fa-id-card-alt', accessRoles: [] },
		  { title : 'Admission Programs', desc: 'Programs Module', url: '/app/ams?mod=programs&view=list',icon:'fa-book', accessRoles: [] },
		  { title : 'Admission Modes', desc: 'Admission Modes', url: '/app/ams?mod=modes&view=list',icon:'fa-chalkboard-teacher', accessRoles: [] },
		  { title : 'Admission Notices', desc: 'Notice Module', url: '/app/ams?mod=notices&view=list',icon:'fa-comment', accessRoles: [] },
