     ...
     <div className="row">
        <div className="Box small-12 columns" style={{width:'900px', margin:'0px auto',float:'none',overflow:'hidden'}}>
            <div className="small-8 columns u-pl-0">
                <p className="u-mb-2">Congratulations! Application process has been finalized. Please <b>Goto Review</b> to edit sections if necessary. This action exists till application close date!</p>
            </div>
            <div className="small-4 columns u-pr-0">
                <button onClick={reviewForm} className="Button u-floatRight u-mb-2 u-ml-2">&nbsp;&nbsp;Goto Review&nbsp;&nbsp;</button>
               ...
               <table class="ptable">
                  ...
                  */}
                  ...
                  { applicant.employment.map((row,i) => 
                   ...
                   <tr>
                       <td colSpan="4">
                           <h3 className="red">IMPORTANT</h3>
                           <h4 className="red wrap">AN APPLICANT WHO MAKES A FALSE STATEMENT OR WITHHOLDS RELEVANT INFORMATION MAY BE REFUSED ADMISSION. IF HE/SHE HAS ALREADY COME INTO THE UNIVERSITY, HE/SHE WILL BE WITHDRAWN.</h4>
                       </td>
                   </tr>
                   <tr><td colSpan="4"><hr/></td></tr>
                   <tr>
                       <td colSpan="4">
                           <h3 className="black">DECLARATION</h3>
                           <h5 className="black wrap serif">I, <b>{applicant.profile.title && getTitle(applicant.profile.title).toUpperCase()} {applicant.profile.lname && applicant.profile.fname && applicant.profile.lname.toUpperCase()+' '+applicant.profile.fname.toUpperCase()}</b> certify that the information provided above is valid and will be held personally responsible for its authenticity and will bear any consequences for any invalid information provided.</h5>
                       </td>
                   </tr>
                   <tr>
                       <td className="sbody">Date of Print</td>
                       <td className="sbody">Applicant ID</td>
                       <td className="sbody">Envelope Number</td>
                       <td className="sbody">Signature of Applicant</td>
                   </tr>
                   <tr>
                       <td className="shead">{moment().format('DD MMM, YYYY')}</td>
                       <td className="shead">{applicant.user.serial}</td>
                       <td className="shead">{/*910/0039*/}........................................</td>
                       <td className="shead">........................................</td>
                   </tr>
